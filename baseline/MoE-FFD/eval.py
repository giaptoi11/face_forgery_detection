...
def test(args, model,test_loader,model_path):
    ...
    print(frame_labels, frame_predictions)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', '-md', type=str, default='/home/toi/research/face_forgery_detection/baseline/MoE-FFD/models/train/models_params_19.tar')
    ...
    root = "/home/toi/research/face_forgery_detection/datasets/cdfv1"
    test_loader = get_dataloader(
        root,
        dataset_name="cdfv1",
        batch_size=1,
